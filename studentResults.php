...
if (mysqli_num_rows($result) > 0) { ?>
      <table id="customers">
        <tr>
          ...
          <th>
            <center>
              <h5>Correct Attempts</h5>
            </center>
          </th>
          <th>
            <center>
              <h5>Wrong Attempts</h5>
            </center>
          </th>
          <th>
            <center>
    ...
    while($row = mysqli_fetch_assoc($result)) {?>
        ...
        <tr>
          ...
          <td>
            <center><?php echo $row['marks'];?></center>
          </td>
          <td>
            <center><?php echo $row['correctAttempts'];?></center>
          </td>
          <td>
            <center><?php echo $row['wrongAttempts'];?></center>
          </td>
          <td>
