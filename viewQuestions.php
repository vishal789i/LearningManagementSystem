...
<body>
    ...
    <div class="w3-top">
      <div class="w3-bar w3-deep-purple">
        <span class="branding w3-bar-item w3-mobile">PICT EXAMINATION PORTAL <?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Teacher Name : ".$_SESSION['empName']."&nbsp;&nbsp;&nbsp;Selected Subject : ".$_SESSION['SubjectGV']." ";?></span>
...
<tr>
      ...
      <th><h4><center>Question</th></h4></center>
		...
		<th><h4><center>Unit</th></h4></center>
      ...
      <th><h4><center>Question Picsource</th></h4></center> 	
</tr>
<?php 
  /*$i= 0;
if (mysqli_num_rows($result) > 0) {*/
    ...
    <tr>
     ...
     $i = $i +1; ?>
		...
		<td><center><?php echo $row['unit'];?></td></center>
    ...
    <?php
    if($row['picsource'] != "") {  ?>
     <td><center></center><a href="<?php echo  $row['picsource']; ?>"> <img src="<?php echo  $row['picsource']; ?>" height = '100' width = '100'/></a>
     <?php } 
       else{
     ?>
     <td><center><?php echo "NA"; ?></td></center>
...
<button class="w3-button w3-red w3-large" onclick="window.location.href='adminSignIn.php'">Go Back</button>
