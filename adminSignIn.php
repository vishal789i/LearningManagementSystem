  ...
  <div class="w3-top">
    <div class="w3-bar w3-black">
      <span class="branding w3-bar-item w3-mobile">PICT EXAMINATION PORTAL
        <?php echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"."Teacher Name : ".$empName." &nbsp;&nbsp;&nbsp;Selected Subject : ".$_SESSION['SubjectGV']." ";?></span>
  ...
  <section class="showcase">
    <div class="w3-container w3-center">
      ...
      <h5 class="w3-animate-opacity "><br><br><br><br>
        <marquee> Now explore our simple way to create your exam.Lets begin with selecting your subject preference.</marquee>
      </h5><br>
      ...
      <button class="w3-button w3-red w3-large" onclick="window.location.href='viewQuestions.php'">Question Bank</button>
      <button class="w3-button w3-red w3-large" onclick="window.location.href='setExamParameters.php'">Configure Exam</button>
	  <button class="w3-button w3-red w3-large" onclick="window.location.href='registeredStudents.php'">Registered Students</button><br><br><br>
	  <button class="w3-button w3-red w3-large" onclick="window.location.href='copo/index.php'">Course Outcome and Program Outcome Mapping</button>
  ...
  <section class="section w3-light-grey">
    <section class="showcase1">
      <div class="w3-container w3-center">
        ...
        <hr>
        <h5 class="w3-animate-opacity ">
          <marquee><b>Now explore our simple way to generate exam result by a single click upon a 'View Results'
        </h5><br></b></marquee>
        <br><br>
        <a href="liveProctoring.php">Live Proctoring</a>
