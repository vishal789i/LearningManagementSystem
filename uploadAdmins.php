...
<?php
	...
	$tableSqlStudents = "CREATE TABLE `adminlogins` ( `id` int(11) NOT NULL AUTO_INCREMENT, `name` varchar(50) NOT NULL, `username` varchar(50) NOT NULL, `password` varchar(50) NOT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=latin1;";
	  ...
	  if(in_array($_FILES["file"]["type"],$allowedFileType)){
			...
			for($i=0;$i<$sheetCount;$i++)
			{
				...
				foreach ($Reader as $Row)
				{
					...
					$query = "INSERT INTO `adminlogins` (`id`, `name`, `username`, `password`) VALUES (NULL, '".$name."', '".$username."','".$password."');";
...
<body>
  ...
  <h3 class="w3-red">
    <center>Upload your admin profiles through an excel sheet !</center>
  </h3>
