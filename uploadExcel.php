	  ...
	  if(in_array($_FILES["file"]["type"],$allowedFileType)){
			...
			for($i=0;$i<$sheetCount;$i++)
			{
				...
				foreach ($Reader as $Row)
				{
					...
					$subjectName = "";
					if(isset($Row[7])) {
						$subjectName = $_SESSION["SubjectGV"];
					}
					...
					$CO = "";
					if(isset($Row[10])) {
						$CO = mysqli_real_escape_string($conn,$Row[10]);
					}

					$M = "";
					if(isset($Row[11])) {
						$M = mysqli_real_escape_string($conn,$Row[11]);
					}
						...
						*/
						$query = "INSERT INTO `question_set` (`question`, `option1`, `option2`, `option3`, `option4`, `f_answer`, `subjectName`, `teacherId`, `unit`, `CO`, `M`) VALUES ('".$question."', '".$option1."', '".$option2."', '".$option3."', '".$option4."', '".$f_answer."', '".$subjectName."', '".$teacherId."', '".$unit."', '".$CO."', '".$M."');";
...
<body>
	...
	<br><br><br><br><br><br>
		...
		<h3 class="w3-red">
			<center>Explore our smart way to upload your questions through an excel sheet !</center>
		</h3>
		<br>
	<center><h5><b>Upload your exel sheet below:</b></h5></center>
